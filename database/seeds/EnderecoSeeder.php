...
class EnderecoSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::insert("INSERT INTO `states` (`id`, `name`, `uf`) VALUES
                    (1, 'Acre', 'AC'),
                    (2, 'Alagoas', 'AL'),
                    (3, 'Amazonas', 'AM'),
                    (4, 'Amapá', 'AP'),
        ...
        DB::insert("INSERT INTO `cities` (`id`, `name`, `state_id`) VALUES
                    (1, 'Afonso Cláudio', 8),
        ...
        $address = new Address();
        $address->street = "Rua Moacir José de Oliveira Souza";
        $address->district = "Santo Agostinho";
        $address->reference = "Triangulo";
        $address->number = 30;
        $address->cities_id = 1;
        $address->save();
    }
